...
//        intakeColour = hardwareMap.get(Sensor);
...
//                    }
            ...
            switch (currentIntakeState) {
                ...
                case intaking:
                    ...
                    if (currentGamepad2.cross && !previousGamepad2.cross && !intakeAbort) { // Start transfer
                        leftIn.setPosition(var.inTransfer);
                        rightIn.setPosition(var.inTransfer);
...
//                        intakeAbort = true; // Set abort flag
                ...
                //Abort logic
//                    if (intakeAbort && abortTimer.seconds() < 0.5 && currentGamepad1.cross && !previousGamepad1.cross) {
//                        gate.setPosition(var.gateClose);
//                        leftIn.setPosition(var.inDown);
//                        rightIn.setPosition(var.inDown);
//                        inWrist.setPosition(var.inWristIntaking);
...
//                        if (horSlide.getCurrentPosition() < 50) {
//                            leftIn.setPosition(var.inTransfer);
//                            rightIn.setPosition(var.inTransfer);
